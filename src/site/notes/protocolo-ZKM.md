---
{"dg-publish":true,"permalink":"/protocolo-zkm/","dg-note-properties":{}}
---
...
**4.5. Método para revisão de erro:** se o usuário recusar a entrega por encurtamente o injustificado de tamanho de arquivo, o trabalho será refeito mediante comparação da versão nova proposta com o arquivo mestre enviado. Os textos serão comparados linha por linha e letra a letra para assegurar que não foi feita qualquer mudança não relacionada necessariamente com a demanda atual.  
