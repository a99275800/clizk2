---
{"dg-publish":true,"permalink":"/14-g79g-config-do-user-json-em-casa/","dg-note-properties":{}}
---

tags: #internas #ajuda #admin #proj_zetteltex #caretstuff #tech !
parent: [[20180227205711\|20180227205711]] caret stuff, o index

## config do user.json em 27/2/19 em casa: copie dos ... para baixo
...

{
  ...
  // look for theme-'.js here: https://github.com/ajaxorg/ace-builds/tree/master/src-noconflict
  ...
  "immersiveFullscreen": true, //hides menus/tabs in Chrome OS fullscreen mode
...
//  "fontFamily": "Glass TTY VT220",
  ...
  "maxSearchMatches": 1500,

  //set a regex to ignore in project view/search

  "ignoreFiles": "node_modules",

  //by default, Caret doesn't show hidden folders (i.e., .git) in its project view
  ...
  // options are "background", "launch", and "silent"

  "updateNotifications": "background",
