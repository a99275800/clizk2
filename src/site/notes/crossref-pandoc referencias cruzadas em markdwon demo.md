---
{"dg-publish":true,"permalink":"/crossref-pandoc-referencias-cruzadas-em-markdwon-demo/","dg-note-properties":{}}
---

title: crossref-pandoc referências cruzadas em markdwon demo
...
tableTemplate: |
  ...
  '(cifrão)(cifrão)tableTitle(cifrão)(cifrão) (cifrão)(cifrão)i(cifrão)(cifrão)'(cifrão)(cifrão)titleDelim(cifrão)(cifrão) (cifrão)(cifrão)t(cifrão)(cifrão)
...
(cifrão)(cifrão) P_i(x) = \sum_i a_i x^i (cifrão)(cifrão) {#eq:eqn1}

Since 0.1.6.0 those can also appear in the middle of paragraph

(cifrão)(cifrão)a x^2 + b x^2 + c = 0(cifrão)(cifrão){#eq:quadr} like this.
...
(cifrão)(cifrão) S(x) = \int_{x_1}^{x_2} a x+b \  \mathrm{d}x (cifrão)(cifrão) {#eq:eqn2}
